...
class RPKServer(SocketServer.BaseRequestHandler):
    userInfo = {
        'yangsq'    : 'yangsq',
        'hudeyong'  : 'hudeyong',
        'mudan'     : 'mudan' }
    ...
    def handle(self):
        ...
        while True:
            ...
            if not receivedData:
                ...
                if RPKServer.userInfo.has_key(self.clientName):
                ...
                if self.clientPwd == RPKServer.userInfo[self.clientName]:
                    self.request.sendall('valid')
                    time.sleep(5)
...
if __name__ == '__main__':
    ...
    srv = SocketServer.ThreadingTCPServer(('localhost', 50000), RPKServer)
    srv.serve_forever()